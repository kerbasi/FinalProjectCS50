...
def takeTanksId():
    ...
    # Contact API
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/vehicles/?application_id=19b782d8b0060bb61337725fda43e527&language=en")
...
def takeGuns():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/modules/?application_id=19b782d8b0060bb61337725fda43e527&extra=default_profile&type=vehicleGun&language=en")
        response.raise_for_status()
    except requests.RequestException:
        return None
    # Parse response
...
def takeRadio():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/modules/?application_id=19b782d8b0060bb61337725fda43e527&type=vehicleRadio&language=en&extra=default_profile")
        response.raise_for_status()
    except requests.RequestException:
        return None
    # Parse response
...
def takeEngines():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/modules/?application_id=19b782d8b0060bb61337725fda43e527&type=vehicleEngine&language=en&extra=default_profile")
        response.raise_for_status()
    except requests.RequestException:
        return None
    # Parse response
...
def takeSuspensions():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/modules/?application_id=19b782d8b0060bb61337725fda43e527&type=vehicleChassis&language=en&extra=default_profile")
        response.raise_for_status()
    except requests.RequestException:
        return None
    # Parse response
...
def takeTurrets():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/modules/?application_id=19b782d8b0060bb61337725fda43e527&type=vehicleTurret&language=en&extra=default_profile")
        response.raise_for_status()
    except requests.RequestException:
        return None
    # Parse response
...
def takeProfileIds():
    ...
    for t in tanks:
        try:
            response = requests.get(f"https://api.worldoftanks.ru/wot/encyclopedia/vehicleprofiles/?application_id=19b782d8b0060bb61337725fda43e527&tank_id={t['id_tank']}&language=en")
            response.raise_for_status()
        except requests.RequestException:
            return None
        #Parse response
        try:
            ...
            for d in data:
                for i in data[d]:
                    if i["profile_id"]:
                        db.execute("INSERT INTO profile_ids (profile_id, tank_id) VALUES (:profile_id, :tank_id)", profile_id=i["profile_id"], tank_id=t['id_tank'])
        except (KeyError, TypeError, ValueError):
           return None
...
def takeProfile(tank_id, profile_id):
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get(f"https://api.worldoftanks.ru/wot/encyclopedia/vehicleprofile/?application_id=19b782d8b0060bb61337725fda43e527&profile_id={profile_id}&language=en&tank_id={tank_id}")
        response.raise_for_status()
    except requests.RequestException:
        return None
    #Parse response
    try:
        ...
        provisionsIDs = db.execute("SELECT provisions FROM tanks WHERE id_tank=:id_tank", id_tank=tank_id)
        provisionsIDs = (provisionsIDs[0]["provisions"].split(", "))
        provisions = db.execute("SELECT * FROM provisions WHERE provision_id in (:provision_id)", provision_id=provisionsIDs)
...
def takeProvisions():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get(f"https://api.worldoftanks.ru/wot/encyclopedia/provisions/?application_id=19b782d8b0060bb61337725fda43e527&language=en")
        response.raise_for_status()
    except requests.RequestException:
        return None
        #Parse response
...
def tanks_updated_at():
    db = SQL("sqlite:///tanks.db")
    try:
        response = requests.get("https://api.worldoftanks.ru/wot/encyclopedia/info/?application_id=19b782d8b0060bb61337725fda43e527")
        response.raise_for_status()
    except requests.RequestException:
        return None
        #Parse response
