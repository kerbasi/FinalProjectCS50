        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            for (let i in tankProfile.ammo) {
                ...
                $('#ammo').append(`<div class="col-xs-1 mr-md-3 ammo">
                                        <a href="#/" onclick=selectAmmo(this); id="ammo${i}" class="ammo"><img src="${imgSrc}" class="rounded mx-auto d-block ammo" alt="Sonar" width="52 px" height="52 px"></a>
                                    </div>`);
            }
            ...
            for (let i in tankProfile.provisions) {
                if (tankProfile.provisions[i].name.indexOf("Camouflage Net") != -1) {
                    ...
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="net" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Binocular") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="binocular" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Improved Ventilation") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="ventilation" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Venting System") != -1) {
                    let imgSrc = '/static/Venting-System.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="ventingSystem" class="improvedEquipment" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }

                if (tankProfile.provisions[i].description) {
                    if (tankProfile.provisions[i].description.indexOf("+10% to suspension") != -1) {
                        let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                        $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                                <a href="#/" onclick=selectOptionalDevice(this); id="optionalSuspension" class="optionalDevice" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                            </div>`);
                    }
                }
                if (tankProfile.provisions[i].description) {
                    if (tankProfile.provisions[i].description.indexOf("-10% to loading time") != -1) {
                        let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                        $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                                <a href="#/" onclick=selectOptionalDevice(this); id="rammer" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                            </div>`);
                    }
                }
                if (tankProfile.provisions[i].name.indexOf("Innovative Loading System") != -1) {
                    let imgSrc = '/static/Innovative-Loading-System.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="innovativeLoadingSystem" class="improvedEquipment" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }

                if (tankProfile.provisions[i].name.indexOf("Enhanced Gun Laying Drive") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="gunLayingDrive" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Wear-Resistant Gun Laying Drive") != -1) {
                    let imgSrc = '/static/Wear-Resistant-Gun-Laying-Drive.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="wearResistantGunLayingDrive" class="improvedEquipment" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }

                if (tankProfile.provisions[i].name.indexOf("Vertical Stabilizer") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="stabilizer" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Stabilizing Equipment System") != -1) {
                    let imgSrc = '/static/Stabilizing-Equipment-System.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="stabilizingSystem" class="improvedEquipment" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                ...
                if (tankProfile.provisions[i].name.indexOf("Coated Optics") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="optics" class="optionalDevice" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Experimental Optics") != -1) {
                    let imgSrc = '/static/Experimental-Optics.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="experimentalOptics" class="improvedEquipment" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }

                if (tankProfile.provisions[i].name.indexOf("Additional Grousers") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="grousers" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Toolbox") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#optionalDevice').append(`<div class="col-xs-1 mr-md-3 optionalDevice">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="toolbox" class="optionalDevice" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Extended Spare Parts Kit") != -1) {
                    let imgSrc = '/static/Toolbox.png';
                    $('#improvedEquipment').append(`<div class="col-xs-1 mr-md-3 improvedEquipment">
                                            <a href="#/" onclick=selectOptionalDevice(this); id="extendedToolbox" class="improvedEquipment" addWeigth="${tankProfile.provisions[i].weight}" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block optionalDevice" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Small Repair Kit") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#regularConsumables').append(`<div class="col-xs-1 mr-md-3 regularConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="repearKit" class="regularConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Small First Aid Kit") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#regularConsumables').append(`<div class="col-xs-1 mr-md-3 regularConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="aidKit" class="regularConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Manual Fire Extinguisher") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#regularConsumables').append(`<div class="col-xs-1 mr-md-3 regularConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="extinguisherst" class="regularConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("100-octane Gasoline") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#regularConsumables').append(`<div class="col-xs-1 mr-md-3 regularConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="100octaneGasoline" class="regularConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Oil") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#regularConsumables').append(`<div class="col-xs-1 mr-md-3 regularConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="oil" class="regularConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Large Repair Kit") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="largeRepearKit" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Large First Aid Kit") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="largeAidKit" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("Automatic Fire Extinguisher") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="automaticFire" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].name.indexOf("105-octane Gasoline") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="105octaneGasoline" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
                if (tankProfile.provisions[i].description) {
                    if (tankProfile.provisions[i].description.indexOf("+10% to all crew skills and perks") != -1) {
                        let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                        $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                                <a href="#/" onclick=selectConsumable(this); id="food" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                            </div>`);
                    }
                }
                if (tankProfile.provisions[i].name.indexOf("Removed Speed Governor") != -1) {
                    let imgSrc = tankProfile.provisions[i].image.replace("http", "https");
                    $('#premiumConsumables').append(`<div class="col-xs-1 mr-md-3 premiumConsumables">
                                            <a href="#/" onclick=selectConsumable(this); id="governor" class="premiumConsumables" data-toggle="tooltip" data-placement="bottom" title="${tankProfile.provisions[i].description}"><img src="${imgSrc}" class="rounded mx-auto d-block consumables" alt="Sonar" width="52 px" height="52 px"></a>
                                        </div>`);
                }
...
function createInfo(reload) {
    ...
    if ($('#wearResistantGunLayingDrive').is(".checked")) {
        ...
        additionalWeight += Number($('#wearResistantGunLayingDrive').attr("addWeigth"));
    ...
    $.each($('a.optionalDevice').not('.checked').not('.disabled'), function () {
        if (($(this).attr('addWeigth') != undefined) && ((Number($(this).attr('addWeigth')) + tankWeight) > tankMaxWeight)) {
    ...
    $.each($('a.improvedEquipment').not('.checked').not('.disabled'), function () {
        if (($(this).attr('addWeigth') != undefined) && ((Number($(this).attr('addWeigth')) + tankWeight) > tankMaxWeight)) {
            $(this).removeAttr('onclick');
            $('img', this).addClass("redBackground");
        } else if (($(this).attr('addWeigth') != undefined)){
    ...
    let comanderLvl = Number($('#crewRange').val()) + ventilation + brothers + food;
    ...
    $('#crewLvl').text(`Comander level: ${comanderLvl} Crew level: ${crewLvl.toFixed(0)}`);
    for (let i in tankProfile.ammo){
    ...
    $('#gunCol1').html(`<div class="text-right font-weight-bold">${tankProfile.gun.name}</div>
                        <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.gun.tier} lvl</div>
                        <div class="text-right"><span class="bold">Damage (min/avg/max):</span> </div>
                        <div class="text-right">${avrDmg[0]}/${avrDmg[1]}/${avrDmg[2]} HP</div>
                        <div class="text-right"><span class="bold">Penetration (min/avg/max):</span> </div>
                        <div class="text-right">${avrPen[0]}/${avrPen[1]}/${avrPen[2]} mm</div>
                        <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.gun.weight} kg</div>`);

    if (tankInfo.turret_id === 0)
    {
        $('#turretCol1').html(`<div class="text-right font-weight-bold">${tankProfile.turret.name}</div>
                            <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.turret.tier} lvl</div>
                            <div class="text-right"><span class="bold">View range:</span> ${tankProfile.turret.view_range} m</div>
                            <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.turret.weight} kg</div>`);
    } else
    {
        $('#turretCol1').html(`<div class="text-right font-weight-bold">${tankProfile.turret.name}</div>
                            <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.turret.tier} lvl</div>
                            ...
                            <div class="text-right">${tankProfile.armor.turret.front}/${tankProfile.armor.turret.sides}/${tankProfile.armor.turret.rear} mm</div>
                            <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.turret.weight} kg</div>`);
    }

    $('#suspensionCol1').html(`<div class="text-right font-weight-bold">${tankProfile.suspension.name}</div>
                        <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.suspension.tier} lvl</div>
                        <div class="text-right"><span class="bold">Traverse speed:</span> ${tankProfile.suspension.traverse_speed} deg/s</div>
                        <div class="text-right"><span class="bold">Load limit:</span> ${tankProfile.suspension.load_limit} kg</div>
                        <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.suspension.weight} kg</div>`);

    $('#engineCol1').html(`<div class="text-right font-weight-bold">${tankProfile.engine.name}</div>
                        <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.engine.tier} lvl</div>
                        <div class="text-right"><span class="bold">Power:</span> ${tankProfile.engine.power} h.p.</div>
                        <div class="text-right"><span class="bold">Fire chance:</span> ${tankProfile.engine.fire_chance * 100} %</div>
                        <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.engine.weight} kg</div>`);

    $('#radioCol1').html(`<div class="text-right font-weight-bold">${tankProfile.radio.name}</div>
                        <div class="text-right"><span class="bold">Tier:</span> ${tankProfile.radio.tier} lvl</div>
                        <div class="text-right"><span class="bold">Signal range:</span> ${tankProfile.radio.signal_range} m</div>
                        <div class="text-right"><span class="bold">Weight:</span> ${tankProfile.radio.weight} kg</div>`);

    //Creating info
    $('#tankParams h1').text(tankInfo.name);
    $('#tankImg').attr('src', tankInfo.images.replace("http", "https"));
    $('.description').text(tankInfo.description);
    $('#gunImg').attr('src', "https://api.worldoftanks.ru/static/2.65.3/wot/encyclopedia/module/ico-guns.gif");
    $('#turretImg').attr('src', "https://api.worldoftanks.ru/static/2.65.0/wot/encyclopedia/module/ico-head.gif");
    $('#susImg').attr('src', "https://api.worldoftanks.ru/static/2.65.0/wot/encyclopedia/module/ico-transm.gif");
    $('#engineImg').attr('src', "https://api.worldoftanks.ru/static/2.65.0/wot/encyclopedia/module/ico-engine.gif");
    $('#radioImg').attr('src', "https://api.worldoftanks.ru/static/2.65.0/wot/encyclopedia/module/ico-radio.gif");
    ...
    if (currentAmmo.stun != null) {
        insertRow("tableFirepower", "Min. stun duration", `${currentAmmo.stun.duration[0]} s`);
        insertRow("tableFirepower", "Max. stun duration", `${currentAmmo.stun.duration[1]} s`);
    }
    ...
    insertRow("tableFirepower", "Reload time", `${(tankProfile.gun.reload_time * rammer * loaderMul).toFixed(2)} <span id="notBaseReload"></span> s`);
    if (tankInfo.turret_id === 0) {
        insertRow("tableFirepower", "Gun traverse speed", `${(tankProfile.gun.traverse_speed * gasoline / gunnerMul).toFixed(2)} <span id="notBaseGunTraverse"></span> deg/s`);
    } else {
        insertRow("tableFirepower", "Gun traverse speed", `${(tankProfile.turret.traverse_speed * gasoline / gunnerMul).toFixed(2)} <span id="notBaseGunTraverse"></span> deg/s`);
    }
    ...
    insertRow("tableFirepower", "Aiming time", `${(tankProfile.gun.aim_time * gunnerMul / gunLayingDrive).toFixed(2)} <span id="notBaseAim"></span> s`);
    ...
    insertRow("tableFirepower", "Average damage per minute", `${(avrDmg[1] * rateFire).toFixed(2)} <span id="notBaseDPM"></span> HP/min`);
    ...
    insertRow("tableMobility", "Load limit", `${(tankMaxWeight / 1000).toFixed(2)} <span id="notBaseLoadLimit"></span> t`);
    insertRow("tableMobility", "Engine power", `${(tankProfile.engine.power * gasoline * oil * governor).toFixed(2)} <span id="notBaseEngine"></span> h.p.`);
    insertRow("tableMobility", "Specific power", `${(tankProfile.engine.power * gasoline * oil * governor / (tankWeight / 1000)).toFixed(2)} <span id="notBasePower"></span> h.p.`);
    insertRow("tableMobility", "Top speed/reverse speed", `${tankProfile.speed_forward}/${tankProfile.speed_backward} km/h`);
    insertRow("tableMobility", "Traverce speed", `${(tankProfile.suspension.traverse_speed * ace * master * grousers / driverMul).toFixed(2)} <span id="notBaseTraverse"></span> deg/s`);

    insertRow("tableSpotting", "View range", `${(tankProfile.turret.view_range * eagle * sonar * binocular / comanderLvlMul).toFixed(2)} <span id="notBaseView"></span> m`);
    ...
    if ((comanderLvl != 100) || (brothers != 0) || (gasoline != 1) || (oil != 1) || (governor != 1)) {
    let sum = ((tankProfile.gun.dispersion * gunnerMul) - (tankProfile.gun.dispersion / gunnerMulBase)).toFixed(2);
        if (sum > 0) {
        ...
        sum = ((tankProfile.engine.power * gasoline * oil * governor) - (tankProfile.engine.power).toFixed(2)).toFixed(2);
        if (sum < 0) {
        ...
        sum = ((tankProfile.engine.power * gasoline * oil * governor/ (tankWeight / 1000)) - (tankProfile.engine.power / (tankWeight / 1000)).toFixed(2)).toFixed(2);
        if (sum < 0) {
        ...
        if (tankInfo.turret_id === 0) {
            sum = ((tankProfile.gun.traverse_speed * gasoline / gunnerMul) - (tankProfile.gun.traverse_speed * gunnerMulBase)).toFixed(2);
        }
        else {
            sum = ((tankProfile.turret.traverse_speed * gasoline / gunnerMul) - (tankProfile.turret.traverse_speed * gunnerMulBase)).toFixed(2);
        }
        if (sum > 0) {
    ...
    if ((comanderLvl != 100) || (brothers != 0) || (rammer != 1)) {
        let sum = ((tankProfile.gun.fire_rate / rammer / loaderMul) - (tankProfile.gun.fire_rate * loaderMulBase)).toFixed(2);
        if (sum >= 0) {
        ...
        sum = ((tankProfile.gun.reload_time * rammer * loaderMul) - (tankProfile.gun.reload_time / loaderMulBase)).toFixed(2);
        if (sum >= 0) {
        ...
        sum = ((avrDmg[1] * tankProfile.gun.fire_rate / rammer / loaderMul) - (avrDmg[1] * tankProfile.gun.fire_rate * loaderMulBase)).toFixed(2);
        if (sum >= 0) {
    ...
    if ((comanderLvl != 100) || (brothers != 0) || (gunLayingDrive != 1)) {
        let sum = ((tankProfile.gun.aim_time * gunnerMul / gunLayingDrive) - (tankProfile.gun.aim_time / gunnerMulBase)).toFixed(2);
        if (sum >= 0) {
    ...
    if ((comanderLvl != 100) || (brothers != 0) || (ace != 1) || (master != 1) || (grousers != 1)) {
        let sum = ((tankProfile.suspension.traverse_speed * ace * master * grousers / driverMul) - (tankProfile.suspension.traverse_speed * driverMulBase)).toFixed(2);
        if (sum >= 0) {
    ...
    if ((comanderLvl != 100) || (brothers != 0) || (eagle != 1) || (sonar != 1) || (binocular != 1)) {
        let sum = ((tankProfile.turret.view_range / comanderLvlMul * eagle * sonar * binocular) - tankProfile.turret.view_range).toFixed(2);
        if (sum >= 0) {
    ...
    if ((optionalSuspension != 1)) {
        let sum = ((tankProfile.max_weight * optionalSuspension - tankProfile.max_weight) / 1000).toFixed(2);
...
function selectOptionalDevice(e) {
    if ($(e).is(".checked")){
        ...
        $('a.optionalDevice, a.improvedEquipment').attr('onclick','selectOptionalDevice(this);');
        ...
        if (optionalDeviceSlots == 0){
            ...
            $('.optionalDevice, .improvedEquipment').not('.checked').removeAttr('onclick');
            $('img', $('a.optionalDevice, a.improvedEquipment').not('.checked')).addClass("opacityLow");
        }
    }
...
function selectConsumable(e) {
    if ($(e).is(".checked")){
        ...
        $('a.regularConsumables, a.premiumConsumables').attr('onclick','selectConsumable(this);');
        $('img', $('a.regularConsumables, a.premiumConsumables')).removeClass("opacityLow");
        ...
        if (consumableSlots == 0){
            ...
            $('.regularConsumables, .premiumConsumables').not('.checked').removeAttr('onclick');
            $('img', $('a.regularConsumables, a.premiumConsumables').not('.checked')).addClass("opacityLow");
        }
    }
